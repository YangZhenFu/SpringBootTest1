...
AirData.initColumn = function () {
    return [
        {field: 'selectItem', radio: true},
            ...
            {title: '传感器名称', field: 'sensorName', visible: true, align: 'center', valign: 'middle', sortable: false},
            {title: '检测数值', field: 'numerical', visible: true, align: 'center', valign: 'middle', sortable: true},
...
AirData.exportExcel = function() {
	...
	var url=Feng.ctxPath+'/air/data/export';
	//调用表格导出插件
...
$(function(){
	 var myZTree = new $ZTree('areaTree',Feng.ctxPath+'/air/station/ztree');
	    ...
	    var table = new BSTable(AirData.id, "/air/data/list", defaultColunms);
