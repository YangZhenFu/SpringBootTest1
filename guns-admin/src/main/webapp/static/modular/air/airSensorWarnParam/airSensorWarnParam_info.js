...
AirSensorWarnParamInfoDlg.close = function() {
    parent.layer.close(window.parent.AirSensorWarnParam.layerIndex);
}
...
AirSensorWarnParamInfoDlg.addSubmit = function() {
    ...
    var ajax = new $ax(Feng.ctxPath + "/airSensorWarnParam/add", function(data){
        Feng.success("添加成功!");
        window.parent.AirSensorWarnParam.table.refresh();
        AirSensorWarnParamInfoDlg.close();
    },function(data){
 ...
 * 提交修改
 */
AirSensorWarnParamInfoDlg.editSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(Feng.ctxPath + "/airSensorWarnParam/update", function(data){
        Feng.success("修改成功!");
        window.parent.AirSensorWarnParam.table.refresh();
        AirSensorWarnParamInfoDlg.close();
    },function(data){
