...
public class CRC16 {
	...
	public static void main(String[] args) {
		...
		int crc1=CRC16.calcCrc16(new byte[] { 0x02,0x04,0x00,0x03,0x00,0x01});
		System.out.println(String.format("0x%04x", crc1));
		int crc2=CRC16.calcCrc16(new byte[]{0x01,0x03,0x00,0x00,0x00,0x02});
		System.out.println(String.format("0x%04x", crc2));
		int crc3=CRC16.calcCrc16(new byte[]{0x01,0x03,0x00,0x01,0x00,0x01});
		System.out.println(String.format("0x%04x", crc3));
		System.out.println(Arrays.toString(calcHighLowCode(crc3)));
		System.out.println(Arrays.toString(CHexConver.hexStr2Bytes("5a 3d")));
	}
	
	public static String[] calcHighLowCode(int crc){
		String code=String.format("0x%04x", crc);
		String[] bytes=new String[2];
		bytes[1]="0x"+code.substring(2, 4);
		bytes[0]="0x"+code.substring(4);
		return bytes;
	}
